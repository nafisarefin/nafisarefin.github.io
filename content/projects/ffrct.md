...
weight: 5
summary: "Deep-learning CTA segmentation with uncertainty quantification to sharpen patient-specific FFR-CT prediction for coronary artery disease. (Ongoing AHA-funded postdoctoral work.)"
pub: 'N. Arefin, C. Georgiadis, M. Usman, A. Narayan, L. Timmins. Quantifying Deep Learning Segmentation-Driven Geometric Uncertainty in Coronary FFR-CT Predictions <em>(in preparation)</em>.'
---
